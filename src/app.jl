function run_app!()
    ...
    css_files = [
        ...
        Dict("href" => "https://codepen.io/giadasp/pen/MWKbOJv.css", "rel" => "stylesheet"),
    ]
    ...
    app.layout = DashCoreComponents.dcc_tabs([
        DashCoreComponents.dcc_tab(
            label = "Create model",
            children = [
                DashHtmlComponents.html_div(
                    ...
                    tabIndex = "-1",
                    role = "dialog",
                    (Symbol("aria-labelledby") => "exampleModalLabel"),
                ...
                DashHtmlComponents.html_div(
                    ...
                    [
                                    ...
                                    [
                                        DashHtmlComponents.html_div(
                                            ...
                                            [
                                                ...
                                                DashHtmlComponents.html_div(
                                                    className = "row justify-content-center m-1 text-center",
                                                    [DashHtmlComponents.html_button(
                                                        "Start ATA";
                                                        id = "start_btn",
                                                        n_clicks = 0,
                        ...
                        DashHtmlComponents.html_div(
                            className = "row d-md-flex justify-content-md-center m-3",
                            [
                                    ...
                                    [
                                        DashHtmlComponents.html_div(
                                            ...
                                            [
                                                ...
                                                DashHtmlComponents.html_div(
                                                    className = "row justify-content-center text-center m-1",
                                                    [DashHtmlComponents.html_button(
                                                        "Add Overlap Matrix";
                                                        id = "addOl_btn",
                                                        n_clicks = 0,
        ...
        DashCoreComponents.dcc_tab(
            label = "assemble!",
            children = [DashHtmlComponents.html_div(
                className = "container-fluid",
                [DashHtmlComponents.html_div(
                    className = "row m-3",
                    [DashHtmlComponents.html_div(
                                                        ...
                                                        [
                                                            ...
                                                            DashHtmlComponents.html_div(
                                                                ...
                                                                [DashCoreComponents.dcc_input(
                                                                    ...
                                                                    max = 1000,
                                                                    step = 1,
                                                                    id = "n_item_StatsBase.sample_txt",
                                                                )],
                                                            ),
                                                        ],
                                                    ),
                                                        ...
                                                        [
                                                            ...
                                                            DashHtmlComponents.html_div(
                                                                ...
                                                                [DashCoreComponents.dcc_input(
                                                                    ...
                                                                    max = 1000,
                                                                    step = 1,
                                                                    id = "n_test_StatsBase.sample_txt",
                                                                )],
                                                            ),
                                                        ],
                                                    ),
    ...
    Dash.callback!(
        ...
        [
            ...
            Dash.State("results_folder_txt", "value"),
        ],
    ) do n_clicks,
    start_temp,
    geom_temp,
        ...
        if n_clicks > 0
            ...
            try
                ...
                if isfile(starting_design)
                    starting_design = Matrix{Float64}(CSV.read(
                        starting_design,
                        delim = ";",
                        header = false,
                    ))
    ...
    Dash.callback!(
        ...
        [
            Dash.State("settings_txt", "value"),
            Dash.State("bank_txt", "value"),
            Dash.State("bank_delim_txt", "value"),
        ],
    ) do n_clicks, settings_file, bank_file, bank_delim
        if n_clicks > 0
            message = ["success", ""]
            try
                message = load_settings!(
                    ATAmodel;
    ...
    Dash.callback!(
        ...
        [
            Dash.State("constraints_file_txt", "value"),
            Dash.State("constraints_delim_txt", "value"),
        ],
    ) do n_clicks, constraints_file, constraints_delim
        if n_clicks > 0
            message = ["success", ""]
            try
                message = add_constraints!(
                    ATAmodel;
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            ...
            try
                message =
                    add_overlap!(ATAmodel; overlap_file = ol_file, overlap_delim = ol_delim)
            catch e
                message[1] = "danger"
                message[2] = sprint(showerror, e)
            end
    ...
    Dash.callback!(
        ...
        if n_clicks > 0
            ...
            if message == ""
                return "ATA model successfully initialized",
                "card h-100 text-white bg-success"
            else
    ...
    Dash.callback!(
        ...
        if success == "card h-100 text-white bg-success"
            return maximum([
                ATAmodel.constraints[t].length_max for t = 1:ATAmodel.settings.T
            ]),
            ATAmodel.settings.T
        else
